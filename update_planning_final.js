...
const regex = /const getPlanningLabels = \(role: RoleType\) => \{[\s\S]*?^};\n/m;

const replacement = `const getPlanningLabels = (role: RoleType) => {
...
console.log('PlanningAgent updated successfully.');
