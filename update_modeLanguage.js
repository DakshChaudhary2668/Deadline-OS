...
// Now add the actual implementations for each role

const studentInsights = \`
    momentumInsights: {
      overloaded: {
        keyObservation: (effort: number) => \`Pending assignments and exam prep peak at \${effort} study hours, saturating your academic timeline.\`,
      ...
      accelerating: {
        keyObservation: (completed: number) => \`Academic timeline shows excellent momentum with \${completed} syllabus milestones mastered in the last 72 hours.\`,
...
const developerInsights = \`
    momentumInsights: {
      overloaded: {
        keyObservation: (effort: number) => \`Pending backlog tickets peak at \${effort} developer hours, saturating your sprint capacity.\`,
      ...
      accelerating: {
        keyObservation: (completed: number) => \`Sprint pipeline shows excellent momentum with \${completed} pull requests merged in the last 72 hours.\`,
...
const job_seekerInsights = \`
    momentumInsights: {
      overloaded: {
        keyObservation: (effort: number) => \`Pending applications and interview prep blocks peak at \${effort} action hours, saturating your career search pipeline.\`,
      ...
      accelerating: {
        keyObservation: (completed: number) => \`Hiring pipeline shows excellent momentum with \${completed} application steps finalized in the last 72 hours.\`,
...
const professionalInsights = \`
    momentumInsights: {
      overloaded: {
        keyObservation: (effort: number) => \`SLA deliverables peak at \${effort} required operational hours, putting significant strain on team resource capacity.\`,
      ...
      accelerating: {
        keyObservation: (completed: number) => \`Operational execution shows rapid upward acceleration with \${completed} milestone completions in the last 72 hours.\`,
